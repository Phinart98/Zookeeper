# declaring multi-line variables that mimic animals in a zzo
...
# While loop to print the animals iteratively untill user exits.
input_message = int(input("Which habitat # do you need? > "))
while str(input_message) != "exit":
	if int(input_message) == 0:
		print(animals[int(input_message)])
	elif int(input_message) == 1:
		print(animals[int(input_message)])
	elif int(input_message) == 2:
		print(animals[int(input_message)])
	elif int(input_message) == 3:
		print(animals[int(input_message)])
	elif int(input_message) == 4:
		print(animals[int(input_message)])
	elif int(input_message) == 5:
		print(animals[int(input_message)])
